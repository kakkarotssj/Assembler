...
void display(char *IR, int *PC)
{
    ...
    if(ALUSIG == 0)
        ...
        printf("ALU SIGNAL : SUB\n");
    else if(ALUSIG == 3)
        printf("ALU SIGNAL : MUL\n");
    else if(ALUSIG == 4)
        printf("ALU SIGNAL : DIV\n");
    else if(ALUSIG == 5)
        printf("ALU SIGNAL : INC\n");
    else if(ALUSIG == 6)
        printf("ALU SIGNAL : DEC\n");
    else
        printf("ALU SIGNAL : CMP\n");
}
